...
<head>
    ...
    <!-- CSS -->
    <link rel="stylesheet" type="text/css" href="<?= base_url($css . '?' . time()) ?>">
    <link rel="stylesheet" type="text/css" href="<?= base_url('../css/responsive.css?' . time()) ?>">
    <link rel="stylesheet" type="text/css" href="<?= base_url('../css/navbar.css?' . time()) ?>">
